...
//    private Class<?> chooseAdequateSet(String field1) {
//        switch (field1) {
//            case "ip":
//            case "user":
//                return String.class;
...
//    }
//
//    private Set<?> generateAnswer(String field1, String field2, String value) {
//        Class<?> clazz = chooseAdequateSet(field1);
//
//        Set<?> resultSet;
...
//                break;
//            case "java.util.Date":
//                resultSet = new HashSet<Date>();
//                break;
//            case "your.package.Event":
//                resultSet = new HashSet<Event>();
//                break;
//            case "your.package.Status":
//                resultSet = new HashSet<Status>();
//                break;
//            default:
...
//                if (clazz == String.class) {
//                    if (field1.equals("ip")) {
//                        ((Set<String>) resultSet).add(getIPFromLine(line));
//                        return resultSet;
//                    } else {
//                        ((Set<String>) resultSet).add(getUserFromLine(line));
//                        return resultSet;
//                    }
//                } else if (clazz == Date.class) {
//                    ((Set<Date>) resultSet).add(getFullDateFromLine(line));
//                    return resultSet;
//                } else if (clazz == Event.class) {
//                    ((Set<Event>) resultSet).add(createEventFromString(getEventFromLine(line)));
//                    return resultSet;
//                } else if (clazz == Status.class) {
//                    ((Set<Status>) resultSet).add(createStatusFromString(getStatusFromLine(line)));
//                    return resultSet;
//                }
//            }
//        }
